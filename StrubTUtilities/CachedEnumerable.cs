...
namespace StrubT {
	...
	public static class CachedEnumerableExtensions {
		...
		public static IEnumerable<T> AsCached<T>(this IEnumerable<T> enumerable) { return enumerable as CachedEnumerable<T> ?? new CachedEnumerable<T>(enumerable); }

		public static IEnumerable<T> AsCached<T>(this IEnumerator<T> enumerator) { return new CachedEnumerable<T>(enumerator); }
	}
}
